...
Optimizer v2.1.4 currently supports (and is tested compatible with) **NextGEN Gallery (v2.0.0 to v2.1.46)**, **NextGEN Legacy (v1.6.2 to v1.9.13)** and **NextCellent Gallery (v1.9.14 to v1.9.31)**.
...
[http://www.nextgengalleryoptimizer.com/nextgen-gallery-optimizer-pro/](http://www.nextgengalleryoptimizer.com/nextgen-gallery-optimizer-pro/)  
...
4. Updated all in-plugin documentation to reflect our new "tested up to" compatibility.
5. Added 256x256, 128x128 and svg plugin icons for the new WordPress plugin installer screen.
...
Please see [Optimizer v2.1's development blog post](http://www.nextgengalleryoptimizer.com/blog/nextgen-gallery-optimizer-v2-1-now-available/) for the full list of improvements and additions.
...
Please see [Optimizer v2.0's development blog post](http://www.nextgengalleryoptimizer.com/blog/nextgen-gallery-optimizer-v2-0-now-available/) for the full list of improvements and additions.
...
* NEW: Optimizer now deregisters the new sitewide stylesheet "framework-min.css" added in NextCellent Gallery 1.9.25+, and only loads it on posts and pages with NextCellent Gallery content. Re: [https://wordpress.org/support/topic/latest-nextcellent-gallery-1925-loading-frameworkcss-file-on-every-page](https://wordpress.org/support/topic/latest-nextcellent-gallery-1925-loading-frameworkcss-file-on-every-page)
...
* NEW: Now fully compatible with the NextGEN Plus (v1.1.3) and NextGEN Pro (v2.1.4) premium add-ons. Re: [https://wordpress.org/support/topic/interferes-with-nextgen-pro-lightbox-controls](https://wordpress.org/support/topic/interferes-with-nextgen-pro-lightbox-controls)
...
* Re: [https://wordpress.org/support/topic/this-plugin-doesnt-do-what-it-says](https://wordpress.org/support/topic/this-plugin-doesnt-do-what-it-says)
...
Re: [https://wordpress.org/support/topic/announcement-nextgen-gallery-optimizer-v20-now-available](https://wordpress.org/support/topic/announcement-nextgen-gallery-optimizer-v20-now-available)
...
Re: [https://wordpress.org/support/topic/question-about-pro-version-1](https://wordpress.org/support/topic/question-about-pro-version-1)
